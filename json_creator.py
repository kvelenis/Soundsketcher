...
def creator(dir):
    ...
    dataframes_list[4].columns = ['Time', 'Value2']
    dataframes_list[6].columns = ['Time', 'Value2']
    dataframes_list[7].columns = ['Time', 'Value2']
    ...
    spectral_flux = dataframes_list[5].iloc[:, 1].tolist()
    spectral_kurtosis = merge_and_fill_values(dataframes_list[1], dataframes_list[4])
    ...
    standard_deviation = merge_and_fill_values(dataframes_list[1], dataframes_list[7])
    ...
    for tms, amp, centroid, zcr, flux, kurtosis, yin_f0, standard_deviation in zip(timestamp, amplitude, spectral_centroid, zerocrossingrate_norm_scaled, spectral_flux, spectral_kurtosis, yin_f0, standard_deviation):
