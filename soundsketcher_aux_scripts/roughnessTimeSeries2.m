function [MPS_roughness, roughness_Zwicker, sharpness_Zwicker, roughness_vassilakis, roughness_sethares, Loudness_SC_Hz] = roughnessTimeSeries2(folderPath)
...
MPS_roughness = cell(numFiles, 1);
roughness_Zwicker = cell(numFiles, 1);
sharpness_Zwicker = cell(numFiles, 1);
